...
export const ContextoProvider = ({ children }) => {
  ...
  const obtenerRegistros = () => {
    let datos = localStorage.getItem('registro')
    if (datos) {
  ...
  const obtenerEstilos = () => {
    let estilos = localStorage.getItem('selectedItems')
    if (estilos) {
  ...
  //--------------------------------------------------------------------------localStorage name
  const ConvertirName = () => {
    let llave = localStorage.getItem('name')
    if (llave) {
  ...
  return (
    <Contexto.Provider value={{
      ...
      validarDatos, setValidarDatos,
      validarNombre, setValidarNombre,
      nombre, setNombre,
      tarea, setTarea,
      selectedItems, setSelectedItems,
      dayNight, setDayNight,
      language, setLanguage, handleLanguage,
